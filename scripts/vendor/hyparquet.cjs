...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/index.js
var index_exports = {};
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/constants.js
var ParquetTypes = [
  "BOOLEAN",
  "INT32",
  "INT64",
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/wkb.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/convert.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/schema.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/thrift.js
var STOP = 0;
var TRUE = 1;
var FALSE = 2;
var BYTE = 3;
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/geoparquet.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/metadata.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/indexes.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/xxhash.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/bloom.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/utils.js
function toJson(obj) {
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/filter.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/plan.js
var runLimit = 1 << 21;
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/variant.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/assemble.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/delta.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/encoding.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/plain.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/snappy.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/datapage.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/column.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/rowgroup.js
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/scan.js
async function parquetScan(options) {
  ...
  const schemaTree2 = parquetSchema(metadata);
  const availableColumns = new Set(columns ?? schemaTree2.children.map((child) => child.element.name));
  ...
  const cache = /* @__PURE__ */ new Map();
  function readColumn2({ column, rowStart, rowEnd }) {
    ...
    if (cached && rowStart >= cached.rowStart && rowEnd <= cached.rowEnd) {
      return cached.data.then((data2) => sliceDecodedArray(
        data2,
...
async function readColumnRange({ options, schemaTree: schemaTree2, group, column, rowStart, rowEnd }) {
  const columnOptions = {
    ...options,
    columns: [column],
    filter: void 0,
  ...
  const assembled = assembleAsync(asyncGroup, schemaTree2, options.parsers);
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/read.js
var rowIndex = (
...
async function parquetReadColumn(options) {
  ...
  const schemaTree2 = parquetSchema(prepared.options.metadata);
  const assembled = asyncGroups.map((group) => assembleAsync(group, schemaTree2, options.parsers));
  await awaitAllColumns(assembled);
  const columnData = [];
...
// ../../../../tmp/hyparquet-build.fJ0or0/package/src/query.js
...
async function parquetReadRows(options) {
  ...
  for (const [rangeStart2, rangeEnd] of rowRanges) {
    ...
    for (let i = rangeStart2; i < rangeEnd; i++) {
      ...
      if (options.includeRowIndex) {
        Object.defineProperty(sparseData[i], rowIndex, { value: groupData[i - rangeStart2][rowIndex] });
      }
    }
  }
  return sparseData;
